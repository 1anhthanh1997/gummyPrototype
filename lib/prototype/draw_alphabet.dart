...
import 'package:web_test/model/person.dart';
...
class _DrawAlphabetState extends State<DrawAlphabet>
  ...
  late Timer deleteTimer;
  late Timer secondDeleteTimer;
  late Timer thirdDeleteTimer;
  late List data;
  List<Person> personData = [];
  List<GameDataModel> alphabetData = [];
  late List<String> imageLink = [];
  late List<Offset> imagePosition = [];
  late List<Offset> startPosition = [];
  late List<Offset> endPosition = [];
  int currentIndex = 0;
